...
class VNLinear(pl.LightningModule):
...
class VNLinearLeakyReLU(pl.LightningModule):
...
class VNLinearAndLeakyReLU(pl.LightningModule):
...
class VNBatchNorm(pl.LightningModule):
...
class VNMaxPool(pl.LightningModule):
